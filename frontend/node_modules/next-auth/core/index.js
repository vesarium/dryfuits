...
async function NextAuthHandler(params) {
  var _req$body$callbackUrl, _req$body, _req$query, _req$body2, _req$cookies, _req$headers, _req$headers$Authoriz, _req$cookies2;
  ...
  const sessionToken = ((_req$cookies = req.cookies) === null || _req$cookies === void 0 ? void 0 : _req$cookies[options.cookies.sessionToken.name]) || ((_req$headers = req.headers) === null || _req$headers === void 0 ? void 0 : (_req$headers$Authoriz = _req$headers.Authorization) === null || _req$headers$Authoriz === void 0 ? void 0 : _req$headers$Authoriz.replace("Bearer ", ""));
  const codeVerifier = (_req$cookies2 = req.cookies) === null || _req$cookies2 === void 0 ? void 0 : _req$cookies2[options.cookies.pkceCodeVerifier.name];
  ...
  return {
    status: 400,
    body: `Error: Action ${action} with HTTP ${req.method} is not supported by NextAuth.js`
  };
}