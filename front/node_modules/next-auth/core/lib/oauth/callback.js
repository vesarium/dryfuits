...
async function oAuthCallback(params) {
  ...
  try {
    var _provider$token, _provider$token2, _provider$userinfo, _ref, _body$user;

    const client = await (0, _client.openidClient)(options);
    let tokens;
    const pkce = await (0, _pkceHandler.usePKCECodeVerifier)({
      options,
      codeVerifier
    });
    const checks = {
      code_verifier: pkce === null || pkce === void 0 ? void 0 : pkce.codeVerifier,
      state: (0, _stateHandler.getState)(options)
    };
    ...
    profile.user = JSON.parse((_ref = (_body$user = body === null || body === void 0 ? void 0 : body.user) !== null && _body$user !== void 0 ? _body$user : query === null || query === void 0 ? void 0 : query.user) !== null && _ref !== void 0 ? _ref : null);
    ...
    return { ...profileResult,
      cookies: pkce !== null && pkce !== void 0 && pkce.cookie ? [pkce.cookie] : undefined
    };
  } catch (error) {
