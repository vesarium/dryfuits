...
function SigninPage(props) {
  ...
  return (0, _preact.h)("div", {
    ...
    }, provider.credentials[credential].label || credential), (0, _preact.h)("input", (0, _extends2.default)({
      name: credential,
      id: `input-${credential}-for-${provider.id}-provider`,
      type: provider.credentials[credential].type || "text",
      placeholder: provider.credentials[credential].placeholder || "Password"
